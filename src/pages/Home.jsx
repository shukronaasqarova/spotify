                    ...
                    <div className='flex flex-col w-1/2'>
                        {playlists.slice(0, 3).map((playlist) => (
                            <div key={playlist.id} className='flex items-center mb-4 '>
                                <img className='w-20 h-20 mr-4 rounded-lg' src={playlist.images[0].url} alt={playlist.name} />
            ...
            <div>
                ...
                <div className='flex flex-wrap justify-center gap-6 p-4'>
                    {(showAllHome ? homePlaylist : homePlaylist.slice(0, 4)).map((playlist) => (
                        <div key={playlist.id} className='bg-[#181818] p-4 rounded-lg shadow-lg w-[180px] hover:bg-gray-800 transition-transform transform hover:scale-105'>
                            <img className='w-full h-36 object-cover rounded-md mb-2' src={playlist.images[0]?.url} alt={playlist.name} />
